...
import { LeaveConfirmation, EditProfile } from '../../components';

const Profile = ({ auth, com }) => {
    const [edit, setEdit] = useState(false);
    const comments = com && auth && com.filter(f => f.uid === auth._id);
                        ...
                        <div>
                            ...
                            <div className='text-center'>
                                <div className='mb-2'>
                                    ...
                                    <h5 className="mb-2 sm:text-xl text-md font-bold text-white">{auth.name}</h5>
                                </div>
                                <div className='mb-6'>
